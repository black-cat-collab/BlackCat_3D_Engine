...
Q_SIGNALS:
    ...
    // Progress
    void downloadProgress(QMTNetwork::RequestTask* pRequestTask, quint64 uiRequestId, qint64 iBytesDownload, qint64 iBytesTotal);
...
private:
    ...
    void updateProgress(QMTNetwork::RequestTask* pRequestTask, quint64 uiRequestId, quint64 uiBatchId,
