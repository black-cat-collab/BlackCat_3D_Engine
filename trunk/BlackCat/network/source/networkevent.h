...
namespace QMTNetwork {
    ...
    namespace NetworkEvent
    {
        ...
        int regiesterEvent(const T& eventName)
        {
            ...
            if (s_mapUserEvent.find(eventName) != s_mapUserEvent.cend())
            {
                return s_mapUserEvent.find(eventName)->second;
            }
    ...
    public:
        ...
        qint64 iBtyes;
        qint64 iTotalBtyes;
        QMTNetwork::RequestTask* pRequestTask;
    };
}
