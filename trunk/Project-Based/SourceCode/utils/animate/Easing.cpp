...
void Easing::Easing_Woking(int  uType, int dwTimer, int dwSleep, ProUpdateFunc fnUpdateFunc, int param1, int param2, double start, double end, int addr) {
	int count;
	double pro;
	double cur;
	bool bStop = false;
	...
	for (int c = 0; c < count; c++)
	{
		...
		if (fnUpdateFunc != 0) { fnUpdateFunc(pro, cur, count, i, bStop, param1, param2); }
		if (pro == 1 || bStop) { break; }
	}
}

bool Easing::Easing_GetProgress(int uType, double start, double end, double pro, double& cur) {
	switch (uType)
	{
...
double Easing::_EasingType_Linear(double& percents_, double _beginvalue, double _endvalue) {
	//percents_ 比例，0~1
...
double Easing::_EasingType_CircularLinearInterpolation(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
...
//弹性缓动
double Easing::_EasingType_Elasticity(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
...
//冲击缓动
double Easing::_EasingType_Impact(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
...
//二次方缓动
double Easing::_EasingType_Quadratic_In(double percents_, double start, double end)
{
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
...
//二次方缓动_In
double Easing::_EasingType_Quadratic_Out(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
...
//二次方缓动_InOut
double Easing::_EasingType_Quadratic_InOut(double percents_, double start, double end) {
	double _ts;
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	_ts = percents_ * 2;
...
//三次方缓动_In
double Easing::_EasingType_Cube_In(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
...
//三次方缓动_Out
double Easing::_EasingType_Cube_Out(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	double _st;
	_st = percents_ - 1;
...
//三次方缓动_InOut
double Easing::_EasingType_Cube_InOut(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	double _st;
	double _ed1;
...
//四次方缓动_In
double Easing::_EasingType_Biquadrate_In(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
...
//四次方缓动_Out
double Easing::_EasingType_Biquadrate_Out(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	double _st;
	_st = percents_ - 1;
...
//四次方缓动_InOut
double Easing::_EasingType_Biquadrate_InOut(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	double _st;
	double _ed1;
...
//五次方缓动_In
double Easing::_EasingType_Fifth_In(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
...
//五次方缓动_Out
double Easing::_EasingType_Fifth_Out(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
...
//五次方缓动_InOut
double Easing::_EasingType_Fifth_InOut(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
...
//正弦曲线缓动
double Easing::_EasingType_Sinusoid_In(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	double _ed1 = end - start;
...
//正弦曲线缓动_InOut
double Easing::_EasingType_Sinusoid_Out(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	double _ed1 = end - start;
...
//正弦曲线缓动_InOut
double Easing::_EasingType_Sinusoid_InOut(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	double _ed1 = end - start;
...
//指数曲线缓动_In
double Easing::_EasingType_IndexCurve_In(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	double _ed1 = end - start;
...
//指数曲线缓动_Out
double Easing::_EasingType_IndexCurve_Out(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	double _ed1 = end - start;
	return _ed1 * (-pow(2, -10 * percents_ / 1) + 1) + start;
...
//指数曲线缓动_InOut
double Easing::_EasingType_IndexCurve_InOut(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	double _st = percents_ * 2;
	double _ed1 = end - start;
...
//圆曲线缓动_In
double Easing::_EasingType_CircularCurve_In(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	double _ed1 = end - start;
...
//圆曲线缓动_Out
double Easing::_EasingType_CircularCurve_Out(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	double _st = percents_ - 1;
	double _ed1 = end - start;
...
//圆曲线缓动_InOut
double Easing::_EasingType_CircularCurve_InOut(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	double _st = percents_ * 2;
	double _ed1 = end - start;
...
//反弹缓动_指数衰减_In
double Easing::_EasingType_Rebound_Damping_In(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
...
//反弹缓动_指数衰减_Out
double Easing::_EasingType_Rebound_Damping_Out(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
...
//反弹缓动_指数衰减_InOut
double Easing::_EasingType_Rebound_Damping_InOut(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	double _ed = end - start;
...
//三次方缓动_溢出_In
double Easing::_EasingType_Cube_Spill_In(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	double _ed = end - start;
	double _s = 1.70158;
...
//三次方缓动_溢出_Out
double Easing::_EasingType_Cube_Spill_Out(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	double _ed = end - start;
	double _s = 1.70158;
...
//三次方缓动_溢出_InOut
double Easing::_EasingType_Cube_Spill_InOut(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	double _ed = end - start;
	double _s = 1.70158;
...
//正弦曲线缓动_指数衰减_In
double Easing::_EasingType_Sinusoid_Damping_In(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
...
//正弦曲线缓动_指数衰减_Out
double Easing::_EasingType_Sinusoid_Damping_Out(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	if (percents_ == 0) { return start; }
	if (percents_ == 1) { return end; }
...
//正弦曲线缓动_指数衰减_InOut
double Easing::_EasingType_Sinusoid_Damping_InOut(double percents_, double start, double end) {
	if (percents_ < 0) { percents_ = 0; }
	if (percents_ > 1) { percents_ = 1; }
	if (percents_ == 0) { return start; }
	double _st = percents_ * 2;
...
double Easing::Easing_getInBounce(double begin_, double end_, double percent_) {
	double _ed = end_ - begin_;
	return _ed - Easing_getOutBounce(0, _ed, 1 - percent_) + begin_;
}

double Easing::Easing_getOutBounce(double begin_, double end_, double percent_) {
...
double Easing::Easing_asin(double value_) {
