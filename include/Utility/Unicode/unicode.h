...
#define DECODE_SHIFT_ILSEQ(r)  ((uint)(RET_SHIFT_ILSEQ(0) - (r)) / 2)
#define DECODE_TOOFEW(r)       ((uint)(RET_TOOFEW(0) - (r)) / 2)
...
namespace bc
{
    ...
    static const ushort cp936ext_2uni_pagea6[181 - 159] = {
        /* 0xa6 */
                                                                0xfe35,
    ...
    static const ushort cp936ext_2uni_pagea8[128 - 122] = {
        /* 0xa8 */
                        0x0251, 0xfffd, 0x0144, 0x0148, 0xfffd, 0x0261,
    };

    static int cp936ext_mbtowc(uint* pwc, const byte* s, size_t n)
    {
        byte c1 = s[0];
        if ((c1 == 0xa6) || (c1 == 0xa8)) {
            if (n >= 2) {
                ...
                if ((c2 >= 0x40 && c2 < 0x7f) || (c2 >= 0x80 && c2 < 0xff)) {
                    uint i = 190 * (c1 - 0x81) + (c2 - (c2 >= 0x80 ? 0x41 : 0x40));
                    ushort wc = 0xfffd;
                    if (i < 7410) {
                        if (i >= 7189 && i < 7211)
    ...
    static const ushort cp936ext_page01[16] = {
    ...
    static const ushort cp936ext_page02[24] = {
    ...
    static const ushort cp936ext_pagefe[24] = {
    ...
    static int cp936ext_wctomb(byte* r, uint wc, size_t n)
    {
        if (n >= 2) {
            ushort c = 0;
    ...
    static const ushort gbkext1_2uni_page81[6080] = {
        /* 0x81 */
    ...
    static int gbkext1_mbtowc(uint* pwc, const byte* s, size_t n)
    {
        byte c1 = s[0];
        if ((c1 >= 0x81 && c1 <= 0xa0)) {
            if (n >= 2) {
    ...
    static const ushort gbkext2_2uni_pagea8[8272] = {
        /* 0xa8 */
    ...
    static int gbkext2_mbtowc(uint* pwc, const byte* s, size_t n)
    {
        byte c1 = s[0];
        if ((c1 >= 0xa8 && c1 <= 0xfe)) {
            if (n >= 2) {
                ...
                if ((c2 >= 0x40 && c2 < 0x7f) || (c2 >= 0x80 && c2 < 0xa1)) {
                    uint i = 96 * (c1 - 0x81) + (c2 - (c2 >= 0x80 ? 0x41 : 0x40));
                    ushort wc = 0xfffd;
                    {
                        if (i < 12016)
    ...
    static const ushort gbkext_inv_2charset[14313] = {
    ...
    static int gbkext_inv_wctomb(byte* r, uint wc, size_t n)
    {
        if (n >= 2) {
    ...
    static const ushort gb2312_2uni_page21[831] = {
        /* 0x21 */
    ...
    static const ushort gb2312_2uni_page30[6768] = {
        /* 0x30 */
    ...
    static int gb2312_mbtowc(uint* pwc, const byte* s, size_t n)
    {
        byte c1 = s[0];
    ...
    static const ushort gb2312_2charset[7445] = {
    ...
    static int gb2312_wctomb(byte* r, uint wc, size_t n)
    {
        if (n >= 2) {
            const Summary16* summary = nullptr;
    ...
    static int gbk_mbtowc(uint* pwc, const byte* s, size_t n)
    {
        byte c = *s;
    ...
    static int gbk_wctomb(byte* r, uint wc, size_t n)
    {
        byte buf[2];
        int ret;
    ...
    static int ascii_mbtowc(uint* pwc, const byte* s, size_t n)
    {
        byte c = *s;
        if (c < 0x80) {
            *pwc = (uint)c;
    ...
    static int ascii_wctomb(byte* r, uint wc, size_t n)
    {
        if (wc < 0x0080) {
            *r = wc;
            return 1;
    ...
    static int euc_cn_mbtowc(uint* pwc, const byte* s, size_t n)
    {
        byte c = *s;
        ...
        return gbk_mbtowc(pwc, s, n);

    }

    static int euc_cn_wctomb(byte* r, uint wc, size_t n)
    {
        int ret;
        /* Code set 0 (ASCII or GB 1988-89) */
        ...
        /* Code set 1 (GBK) */
        ret = gbk_wctomb(r, wc, 2);

        return ret;
    }

    static int utf8_mbtowc(uint* pwc, const byte* s, size_t n)
    {
        byte c = s[0];
        ...
        else if (c < 0xf8 && sizeof(uint) * 8 >= 32) {
            if (n < 4)
                return RET_TOOFEW(0);
            if (!((s[1] ^ 0x80) < 0x40 && (s[2] ^ 0x80) < 0x40
                && (s[3] ^ 0x80) < 0x40
        ...
        else if (c < 0xfc && sizeof(uint) * 8 >= 32) {
            if (n < 5)
                return RET_TOOFEW(0);
            if (!((s[1] ^ 0x80) < 0x40 && (s[2] ^ 0x80) < 0x40
        ...
        else if (c < 0xfe && sizeof(uint) * 8 >= 32) {
            if (n < 6)
                return RET_TOOFEW(0);
            if (!((s[1] ^ 0x80) < 0x40 && (s[2] ^ 0x80) < 0x40
                && (s[3] ^ 0x80) < 0x40 && (s[4] ^ 0x80) < 0x40
    ...
    static int utf8_wctomb(byte* r, uint wc, size_t n) /* n == 0 is acceptable */
    {
        int count;
        if (wc < 0x80)
            count = 1;
